        ...
        <div className="rmdb-movieinfo"
            ...
            <div className="rmdb-movieinfo-content">
                <div className="rmdb-movieinfo-thumb">
                    <MovieThumb image={props.movie.backdrop_path ? `${IMAGE_BASE_URL}${POSTER_SIZE}${props.movie.poster_path}` : '.\images\no_image.jpg'}
                        clickable={false}
                    />
                </div>
                <div className="rmdb-movieinfo-text">
                    ...
                    <div className="rmdb-rating">
                        ...
                        <p className="rmdb-percent">{props.movie.vote_average}</p>
                    </div>
